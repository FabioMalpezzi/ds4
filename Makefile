...
.PHONY: all help clean test test-agent-context-loop test-agent-context-compact-canary test-agent-self-improvement test-kv-cache-benefit cpu cuda cuda-spark cuda-generic cuda-regression
...
help:
	...
	@echo "  make test-agent-self-improvement"
	@echo "                    Run slow DS4-generated Git+KV self-improvement e2e"
...
ds4-agent: ds4_agent.o ds4_agent_context.o ds4_agent_git.o ds4_help.o ds4_web.o ds4_kvstore.o linenoise.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ ds4_agent.o ds4_agent_context.o ds4_agent_git.o ds4_help.o ds4_web.o ds4_kvstore.o linenoise.o $(CORE_OBJS) $(METAL_LDLIBS)

cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_agent_context.o ds4_agent_git.o ds4_help.o ds4_web.o ds4_kvstore.o linenoise.o rax.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-agent ds4_agent_cpu.o ds4_agent_context.o ds4_agent_git.o ds4_help.o ds4_web.o ds4_kvstore.o linenoise.o $(CPU_CORE_OBJS) $(LDLIBS)
...
ds4_agent.o: ds4_agent.c ds4.h ds4_agent_context.h ds4_agent_git.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
...
ds4_agent_cpu.o: ds4_agent.c ds4.h ds4_agent_context.h ds4_agent_git.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
...
test: ds4_test ds4-eval tests/ds4_agent_context_test tests/ds4_agent_git_test q4k-dot-test
...
test-agent-self-improvement: ds4-agent
	sh tests/ds4_agent_self_improvement_e2e.sh
